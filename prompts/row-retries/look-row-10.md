Create Codex v2 pet look row 10 for `xiao-haila` as exactly 8 full-body frames in this order: 180, 202.5, 225, 247.5, 270, 292.5, 315, 337.5.

CRITICAL FINAL-CELL EDGE LOCK: the previous 247.5 pose became too wide after applying the approved row-9 scale. Keep every pose, especially 247.5, narrower and more compact around the planted torso: tuck the long hair and parasol silhouette inward, keep skirt feathers close, and preserve generous green space on both sides. At 247.5 the left-facing head/gaze must remain clear, but no hair tip, parasol edge, ribbon, hand, or skirt feather may approach the invisible cell boundary. Do not solve this by changing identity or reducing only one pose's body scale; synthesize the whole row as one consistently compact family.
